...
## pixiv 株式会社 機械学習・MLOps 基盤エンジニア (2021/04~現在)
...
- GCP におけるインフラ構築
  ...
  - GKE/GCS/Artifact Registory/IAP/VPC network/Managed SSL/BQ
- kubernetes の整備
  - マニフェストファイルの作成
  - kustomize による環境整備
- CI/CD の整備
  - GitlabCI を通じたデプロイの整備
...
- 採用
  ...
  - 面接の責任者
    ...
    機械学習エンジニアにおける、アルバイト・新卒・中途・業務委託の採用業務を行なっていた。（採用のためにはマネージャーの承認が必要だった)。応募要項の作成・面接シートの制定・書類選考・1 次面接における判断を行なっていた。
...
- 個人ブログ
  ...
  技術ブログ zenn: https://zenn.dev/sugasuga

  個人開発サービスの話: https://zenn.dev/sugasuga/articles/83a1ff1c62aa53

- 大学・大学院時代の論文

  - 学会論文: NBL 送りバント研究 ~無死一塁における最適行動~
  - 卒業論文: 球審の判定の歪みと戦略としての転用可能性?
...
- git
  ...
  https://github.com/sugakoji

- 受賞歴

  kaggle expert(銀 2、銅 1)  
  日本統計学会 統計数理研究所 第 8 回スポーツデータ解析コンペティション　学生奨励賞  
  日本統計学会 統計数理研究所 第 7 回スポーツデータ解析コンペティション　 SEM 賞  
  第 6 回慶応データ解析コンテスト　入賞  
...
2019 立教大学 経営学科国際経営学科卒業  
2021 慶應大学大学院 経済大学院卒業
